...
def generate_launch_description():
    ...
    auto_client = LaunchConfiguration(auto_client_name)
    ...
    robot_description_config = Command(
        ...
        # [FindExecutable(name='xacro'), ' ', franka_xacro_file, ' hand:=true', ' gazebo:=true',
    ...
    robot_description_semantic_config = Command(
        ...
        #  franka_semantic_xacro_file, ' hand:=true', ' gazebo:=true']
    )
    ...
    my_franka_control_node = Node(
        package="franka_control_package",
